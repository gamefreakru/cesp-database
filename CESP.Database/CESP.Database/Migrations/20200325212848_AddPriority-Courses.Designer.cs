...
namespace CESP.Database.Migrations
{
    ...
    [Migration("20200325212848_AddPriority-Courses")]
    partial class AddPriorityCourses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CESP.Database.Context.Education.Models.CourseFileDto", b =>
                {
                    ...
                    b.ToTable("course_files");
                });

            modelBuilder.Entity("CESP.Database.Context.Education.Models.LanguageDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("CESP.Database.Context.Education.Models.TeacherDto", b =>
                {
                    ...
                    b.HasIndex("LargePhotoId");

                    b.HasIndex("PhotoId");

                    b.HasIndex("SmallPhotoId");

                    b.ToTable("teachers");
                });

            modelBuilder.Entity("CESP.Database.Context.Feedbacks.Models.FeedbackDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("CESP.Database.Context.Feedbacks.Models.FeedbackSourceDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("CESP.Database.Context.Education.Models.LanguageDto", b =>
                {
                    b.HasOne("CESP.Database.Context.Education.Models.TeacherDto")
                        .WithMany("Languages")
            ...
            modelBuilder.Entity("CESP.Database.Context.Education.Models.TeacherDto", b =>
                {
                    b.HasOne("CESP.Database.Context.Files.Models.FileDto", "LargePhoto")
                        .WithMany()
                        .HasForeignKey("LargePhotoId");
                    ...
                    b.HasOne("CESP.Database.Context.Files.Models.FileDto", "SmallPhoto")
                        .WithMany()
                        .HasForeignKey("SmallPhotoId");
                });
            ...
            modelBuilder.Entity("CESP.Database.Context.Feedbacks.Models.FeedbackDto", b =>
                {
                    ...
                    b.HasOne("CESP.Database.Context.Feedbacks.Models.FeedbackSourceDto", "Source")
                        .WithMany()
